...
void main() {
  test("ProbabilityCalculator have defined final value for base probability", () {
    final underTest = AttributeProbabilityCalculator();
  ...
  test("ProbabilityCalculator accepts character to calculate Probability for grades s, a, b and c", () {
    ...
    final underTest = AttributeProbabilityCalculator();
    Probability<AttributeTag> returned = underTest.calculateProbability(character);
    // ignore: unnecessary_type_check
    assert(returned is Probability<AttributeTag>);
